...
# ═══════════════════════════════════════════════════════════════
FUENTES_RSS = [
    {"nombre": "El Heraldo", "url": "https://www.elheraldo.co/arc/outboundfeeds/rss/", "categorias": ["general", "barranquilla", "judicial", "politica", "deportes", "economia", "cultura", "salud", "tecnologia", "mundo"], "tipo": "nacional"},
    ...
    {"nombre": "Semana", "url": "https://www.semana.com/arc/outboundfeeds/rss/?outputType=xml", "categorias": ["general", "politica", "economia", "cultura", "deportes", "tecnologia", "salud", "mundo", "judicial", "justicia", "vida", "virales"], "tipo": "nacional"},
    {"nombre": "Valora Analitik", "url": "https://www.valoraanalitik.com/feed/", "categorias": ["economia", "finanzas", "negocios"], "tipo": "nacional"},
    {"nombre": "Forbes Colombia", "url": "https://forbes.co/seccion/economia-y-finanzas/", "categorias": ["economia", "negocios"], "tipo": "nacional"},
    {"nombre": "Infobae Colombia", "url": "https://www.infobae.com/arc/outboundfeeds/rss/category/colombia/", "categorias": ["general", "colombia", "politica", "judicial", "justicia", "economia", "tecnologia"], "tipo": "nacional"},
    {"nombre": "La Nota Económica", "url": "https://lanotaeconomica.com.co/feed/", "categorias": ["economia", "negocios", "mis finanzas"], "tipo": "nacional"},
